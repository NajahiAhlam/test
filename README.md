<nb-card style="width: 700px;">
    ...
    <nb-card-body>
      <form [formGroup]="form" autocomplete="off">
        ...
        <!-- Condition form -->
              <div *ngIf="validationValue =='Avec Condition'">
    ...
    ngOnInit() {
      ...
      this.validationValue = value;
        ...
        this.userService.getUsersList().subscribe(sponsors => {
          ...
          this.filteredAssigneOptions$ = this.form.get('sponsor')!.valueChanges.pipe(
            startWith(''),
...
}the assign select filteredAssigneOptions$ doesnt work 
